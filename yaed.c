...
/* If you declare any globals in php_yaed.h uncomment this:
ZEND_DECLARE_MODULE_GLOBALS(yaed)
*/
...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("yaed.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_yaed_globals, yaed_globals)
    STD_PHP_INI_ENTRY("yaed.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_yaed_globals, yaed_globals)
PHP_INI_END()
*/
/* }}} */
...
/* {{{ proto string confirm_yaed_compiled(string arg)
...
#ifdef COMPILE_DL_YAED
ZEND_GET_MODULE(yaed)
#endif
